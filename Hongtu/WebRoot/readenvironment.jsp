  ...
  <script type="text/javascript">
    ...
    <jsp:include page="toubu.jsp"/><br/>
    	<table align='center' border='0' width='75%'>
    		...
    		<tr align='center'><td><div style='margin: 1em;color:background'>${read.title }</div></td></tr>
    		<tr style='text-align: center'>
    			<td >
    				<ul style='list-style: none;'>
    				<li style="float: left;width: 49%;">
    				<table id="t1" onmouseout="doout('t1');" onmouseover="doover('t1');" border='2'  align="right"><tr><td><a style=" font-size: large;color:black" href='qt?method=lastenvironment&id=${read.id }'>上一个</a></td></tr></table>
    				</li>
    				<li style="float: left;width: 2%;">
    					&nbsp;
    				</li>
    				<li style="float: left;width: 49%">
    				<table id='t2'  onmouseout="doout('t2');" onmouseover="doover('t2');"  border='2'  ><tr><td><a style=" font-size: large;color:black; " href='qt?method=nextenvironment&id=${read.id }'>下一个</a></td></tr></table>
    				</li>
    				</ul>
    			</td>
    		</tr>
