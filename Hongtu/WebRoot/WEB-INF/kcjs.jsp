...
<html>
  ...
  <!-- META DATA -->
	...
	<!-- Custom CSS -->
    <link rel="stylesheet" href="css-kcjs/style.css">
 ...
 <table style="background-color:#057fac" width="100%">
		<tr><td>
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
	...
	<header class="container">
		<div class="site-branding">
			<h1 class="site-title"><font face="微软雅黑">课程介绍</font></h1>
			<h2 class="site-description">Welcome to HT !</h2>
		</div>
	</header>
	...
	<div id="page-content">
		...
		<c:forEach items="${courselist}" var="c">
					<div class="col-md-4">
						<div class="box-item" style="width: 360px;height: 520px">
						
							<img src="${c.imgs }" class="img-responsive"/>
						
							<div class="content">
								<h3 align="center"><font face="微软雅黑">${c.course }</font></h3>
								<p><font face="微软雅黑">${c.detail }</font></p>
								<br><br>
								<div align="left"><span><font face="微软雅黑">2018年6月25日</font></span></div>
							</div>
						</div>
					</div>
		</c:forEach>
...
<div id="container">
	...
	<div id="content" align="center">
		...
		<table cellspacing="0" cellpadding="0" style="width: 80%;align="center">
			<tr style="height: 50px">
				<th colspan="6" style='text-align:center'><font size="4" face="微软雅黑">宏图软件专业课程表</font></th>
			</tr>
