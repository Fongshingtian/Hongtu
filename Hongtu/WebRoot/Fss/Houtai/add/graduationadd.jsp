...
<html>
  <head>
	...
	毕业学生表图
	</div>	<form action='hongtu?method=graduationadd' method='post' enctype="multipart/form-data">
	<div class="zhuce">
	<div class="text">
        <span>标题</span>
        <input type="text" name='title' placeholder="请输入标题" class="input" onchange="getface();">
    </div>
    <div class="text">
        <span>图片</span>
         &nbsp;&nbsp;&nbsp;&nbsp;
