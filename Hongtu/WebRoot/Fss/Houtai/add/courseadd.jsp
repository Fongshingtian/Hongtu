...
<html>
  <head>
	...
	<div style="text-indent: -17em">课程介绍添加</div>
	</div>	<form action='hongtu?method=courseadd' method='post' enctype="multipart/form-data">
	<div class="zhuce">
	<div class="text">
        <span>课程名字</span>
        <input type="text" name='course' placeholder="请输入课程" class="input">
    </div>
    <div class="text">
        <span>封面</span>
        &nbsp;&nbsp;&nbsp;&nbsp;
