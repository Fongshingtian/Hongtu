...
<html>
  <head>
	...
	<h3 style="text-indent:-14em;">新闻动态</h3>  
	</div>	
	<form action='hongtu?method=newsadd' method='post'>
		<div class="zhuce">
		<div class="text">
	        <span>标题</span>
	        <input type="text" name='title' placeholder="请输入标题" class="input">
	        <span>创建时间</span>
			<input type="text" name='ctime' placeholder="请输入时间" class="input">
	    </div>
			<div style="width:90%;align;margin:0 auto" id='editor'>
			
			</div>
			<input type='hidden' id='contents' name='contents'>
	    <div class="btndl"><input type="submit" value="添加" onclick="getcontents();" ></div>
		</div>
		</form>
