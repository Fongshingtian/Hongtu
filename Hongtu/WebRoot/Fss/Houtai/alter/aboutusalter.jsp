...
<html>
  <head>
	...
	<h3 style="text-indent:-17em;">编辑关于我们</h3>  
	</div>	
	<form action='hongtu?method=aboutusalter&id=${aboutusinfo.id }' method='post'>
		<div class="zhuce">
		<div class="text">
	        <span>标题</span>
	        <input type="text" name='title' placeholder="请输入标题" value='${aboutusinfo.title }' class="input">
	    </div>
